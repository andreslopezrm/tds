import {
  require_react_dom
} from "/build/_shared/chunk-YBOWSGR3.js";
import {
  require_ssr
...
import "/build/_shared/chunk-STNWSKCN.js";
import {
  init_esm,
  useLoaderData
      ...
      function areObjectsEqual(a2, b, isEqual, meta) {
        ...
        if (index) {
          ...
          while (index-- > 0) {
            ...
            if (!hasOwnProperty(b, key) || !isEqual(a2[key], b[key], meta)) {
              return false;
            }
          }
        }
...
var require_CSSTransition = __commonJS({
  "node_modules/react-transition-group/CSSTransition.js"(exports, module) {
    ...
    var CSSTransition = /* @__PURE__ */ function(_React$Component) {
      ...
      _proto.render = function render() {
        var props = _extends22({}, this.props);
        delete props.classNames;
        return _react.default.createElement(_Transition.default, _extends22({}, props, {
    ...
    CSSTransition.propTypes = true ? _extends22({}, _Transition.default.propTypes, {
...
var require_TransitionGroup = __commonJS({
  "node_modules/react-transition-group/TransitionGroup.js"(exports, module) {
    ...
    var TransitionGroup2 = /* @__PURE__ */ function(_React$Component) {
      ...
      _proto.handleExited = function handleExited(child, node) {
        ...
        if (this.mounted) {
          this.setState(function(state) {
            var children = _extends22({}, state.children);
      ...
      _proto.render = function render() {
        var _this$props = this.props, Component5 = _this$props.component, childFactory = _this$props.childFactory, props = _objectWithoutPropertiesLoose13(_this$props, ["component", "childFactory"]);
...
var DefaultLegendContent = /* @__PURE__ */ function(_PureComponent) {
  ...
  _createClass2(DefaultLegendContent2, [{
    key: "renderIcon",
    value: function renderIcon(data2) {
      ...
      if (/* @__PURE__ */ import_react5.default.isValidElement(data2.legendIcon)) {
        var iconProps = _objectSpread({}, data2);
        delete iconProps.legendIcon;
        return /* @__PURE__ */ import_react5.default.cloneElement(data2.legendIcon, iconProps);
      }
...
var isChildrenEqual = function isChildrenEqual2(nextChildren, prevChildren) {
  ...
  var count = import_react13.Children.count(nextChildren);
  if (count !== import_react13.Children.count(prevChildren)) {
    return false;
  }
  if (count === 0) {
    return true;
...
init_react();
function quickselect(array, k2, left = 0, right = array.length - 1, compare) {
...
function band() {
  ...
  function rescale() {
    ...
    var values = range3(n).map(function(i) {
      return start + step * i;
    });
...
var renderRadialLabel = function renderRadialLabel2(labelProps, label, attrs) {
  ...
  return /* @__PURE__ */ import_react14.default.createElement("text", _extends7({}, attrs, {
...
function Label(props) {
  ...
  if (!viewBox || (0, import_isNil7.default)(value) && (0, import_isNil7.default)(children) && !/* @__PURE__ */ (0, import_react14.isValidElement)(content) && !(0, import_isFunction4.default)(content)) {
    return null;
  }
  if (/* @__PURE__ */ (0, import_react14.isValidElement)(content)) {
    return /* @__PURE__ */ (0, import_react14.cloneElement)(content, props);
  }
  var label;
  if ((0, import_isFunction4.default)(content)) {
    label = /* @__PURE__ */ (0, import_react14.createElement)(content, props);
    if (/* @__PURE__ */ (0, import_react14.isValidElement)(label)) {
      return label;
    }
  } else {
  ...
  return /* @__PURE__ */ import_react14.default.createElement(Text, _extends7({
...
var parseLabel = function parseLabel2(label, viewBox) {
  ...
  if (/* @__PURE__ */ (0, import_react14.isValidElement)(label)) {
    if (label.type === Label) {
      return /* @__PURE__ */ (0, import_react14.cloneElement)(label, {
        key: "label-implicit",
        viewBox
      });
    }
  ...
  if ((0, import_isObject2.default)(label)) {
    return /* @__PURE__ */ import_react14.default.createElement(Label, _extends7({
      viewBox
    }, label, {
      key: "label-implicit"
    }));
...
function LabelList(props) {
  var data2 = props.data, valueAccessor2 = props.valueAccessor, dataKey = props.dataKey, clockWise = props.clockWise, id = props.id, textBreakAll = props.textBreakAll, others = _objectWithoutProperties8(props, ["data", "valueAccessor", "dataKey", "clockWise", "id", "textBreakAll"]);
  ...
  return /* @__PURE__ */ import_react15.default.createElement(Layer, {
    ...
    return /* @__PURE__ */ import_react15.default.createElement(Label, _extends8({}, filterProps(entry, true), others, idProps, {
...
function parseLabelList(label, data2) {
  ...
  if (/* @__PURE__ */ import_react15.default.isValidElement(label) || (0, import_isFunction5.default)(label)) {
    return /* @__PURE__ */ import_react15.default.createElement(LabelList, {
      key: "labelList-implicit",
      data: data2,
      content: label
  ...
  if ((0, import_isObject3.default)(label)) {
    return /* @__PURE__ */ import_react15.default.createElement(LabelList, _extends8({
      data: data2
    }, label, {
      key: "labelList-implicit"
    }));
...
var Sector = /* @__PURE__ */ function(_PureComponent) {
  ...
  _createClass9(Sector2, [{
    ...
    value: function render() {
      ...
      return /* @__PURE__ */ import_react16.default.createElement("path", _extends9({}, filterProps(this.props, true), {
        className: layerClass,
        d: path2
      }));
    }
...
var Curve = /* @__PURE__ */ function(_PureComponent) {
  ...
  _createClass10(Curve2, [{
    ...
    value: function render() {
      ...
      return /* @__PURE__ */ import_react17.default.createElement("path", _extends10({}, filterProps(this.props), adaptEventHandlers(this.props), {
  ...
  _createClass11(Rectangle2, [{
    ...
    value: function render() {
      ...
      if (!isUpdateAnimationActive) {
        return /* @__PURE__ */ import_react18.default.createElement("path", _extends11({}, filterProps(this.props, true), {
          className: layerClass,
          d: getRectanglePath(x2, y2, width, height, radius)
        }));
      }
      return /* @__PURE__ */ import_react18.default.createElement(es6_default, {
        ...
        }, /* @__PURE__ */ import_react18.default.createElement("path", _extends11({}, filterProps(_this2.props, true), {
          className: layerClass,
...
var Dot = /* @__PURE__ */ function(_PureComponent) {
  ...
  _createClass12(Dot2, [{
    ...
    value: function render() {
      ...
      if (cx === +cx && cy === +cy && r === +r) {
        return /* @__PURE__ */ import_react19.default.createElement("circle", _extends12({}, filterProps(this.props), adaptEventHandlers(this.props), {
          className: layerClass,
          cx,
          cy,
          r
...
var Cross = /* @__PURE__ */ function(_PureComponent) {
  ...
  _createClass13(Cross2, [{
    ...
    value: function render() {
      ...
      return /* @__PURE__ */ import_react20.default.createElement("path", _extends13({}, filterProps(this.props, true), {
...
var Brush = /* @__PURE__ */ function(_PureComponent) {
  ...
  _createClass14(Brush2, [{
    ...
    value: function renderBackground() {
      ...
      return /* @__PURE__ */ import_react21.default.createElement("rect", {
        stroke,
        fill,
        x: x2,
        y: y2,
    ...
    value: function renderPanorama() {
      ...
      var chartElement = import_react21.Children.only(children);
      if (!chartElement) {
        return null;
      }
      return /* @__PURE__ */ import_react21.default.cloneElement(chartElement, {
        x: x2,
        y: y2,
        width,
        height,
    ...
    value: function renderText() {
      ...
      }, /* @__PURE__ */ import_react21.default.createElement(Text, _extends14({
        textAnchor: "end",
        verticalAnchor: "middle",
        x: Math.min(startX, endX) - offset,
        y: y2 + height / 2
      }, attrs), this.getTextOfTick(startIndex)), /* @__PURE__ */ import_react21.default.createElement(Text, _extends14({
        textAnchor: "start",
        verticalAnchor: "middle",
    ...
    value: function render() {
      ...
      var isPanoramic = import_react21.default.Children.count(children) === 1;
    ...
    value: function renderDefaultTraveller(props) {
      ...
      return /* @__PURE__ */ import_react21.default.createElement(import_react21.default.Fragment, null, /* @__PURE__ */ import_react21.default.createElement("rect", {
        x: x2,
        y: y2,
        width,
        height,
    ...
    value: function renderTraveller(option, props) {
      var rectangle;
      if (/* @__PURE__ */ import_react21.default.isValidElement(option)) {
        rectangle = /* @__PURE__ */ import_react21.default.cloneElement(option, props);
...
var renderLine = function renderLine2(option, props) {
  ...
  if (/* @__PURE__ */ import_react22.default.isValidElement(option)) {
    line = /* @__PURE__ */ import_react22.default.cloneElement(option, props);
  } else if ((0, import_isFunction8.default)(option)) {
    line = option(props);
  } else {
    line = /* @__PURE__ */ import_react22.default.createElement("line", _extends15({}, props, {
...
ReferenceDot.renderDot = function(option, props) {
  ...
  if (/* @__PURE__ */ import_react23.default.isValidElement(option)) {
    dot = /* @__PURE__ */ import_react23.default.cloneElement(option, props);
  } else if ((0, import_isFunction9.default)(option)) {
    dot = option(props);
  } else {
    dot = /* @__PURE__ */ import_react23.default.createElement(Dot, _extends16({}, props, {
      cx: props.cx,
      cy: props.cy,
...
ReferenceArea.renderRect = function(option, props) {
  ...
  if (/* @__PURE__ */ import_react24.default.isValidElement(option)) {
    rect = /* @__PURE__ */ import_react24.default.cloneElement(option, props);
  } else if ((0, import_isFunction10.default)(option)) {
    rect = option(props);
  } else {
    rect = /* @__PURE__ */ import_react24.default.createElement(Rectangle, _extends17({}, props, {
...
var CartesianAxis = /* @__PURE__ */ function(_Component) {
  ...
  _createClass16(CartesianAxis2, [{
    ...
    value: function renderAxisLine() {
      ...
      return /* @__PURE__ */ import_react25.default.createElement("line", _extends18({}, props, {
    ...
    value: function renderTicks(ticks2) {
      ...
      var items = finalTicks.map(function(entry, i) {
        ...
        return /* @__PURE__ */ import_react25.default.createElement(Layer, _extends18({
          ...
          key: "tick-".concat(i)
        }, adaptEventsOfChild(_this.props, entry, i)), tickLine && /* @__PURE__ */ import_react25.default.createElement("line", _extends18({}, tickLineProps, lineCoord, {
    ...
    value: function getTicksStart(_ref2, preserveEnd) {
      var ticks2 = _ref2.ticks, tickFormatter = _ref2.tickFormatter, viewBox = _ref2.viewBox, orientation = _ref2.orientation, minTickGap = _ref2.minTickGap, unit2 = _ref2.unit;
...
function ErrorBar(props) {
  var offset = props.offset, layout = props.layout, width = props.width, dataKey = props.dataKey, data2 = props.data, dataPointFormatter = props.dataPointFormatter, xAxis = props.xAxis, yAxis = props.yAxis, others = _objectWithoutProperties10(props, ["offset", "layout", "width", "dataKey", "data", "dataPointFormatter", "xAxis", "yAxis"]);
  ...
  var errorBars = data2.map(function(entry, i) {
    ...
    return /* @__PURE__ */ import_react26.default.createElement(Layer, _extends19({
      ...
      return /* @__PURE__ */ import_react26.default.createElement("line", _extends19({}, coordinates, {
...
var Line = /* @__PURE__ */ function(_PureComponent) {
  ...
  _createClass17(Line2, [{
    ...
    value: function renderDots(needClip, clipPathId) {
      ...
      return /* @__PURE__ */ import_react27.default.createElement(Layer, _extends20({
    ...
    value: function renderCurveStatically(points, needClip, clipPathId, props) {
      ...
      return /* @__PURE__ */ import_react27.default.createElement(Curve, _extends20({}, curveProps, {
    ...
    value: function render() {
      ...
      var layerClass = (0, import_classnames19.default)("recharts-line", className);
      ...
      return /* @__PURE__ */ import_react27.default.createElement(Layer, {
        className: layerClass
      }, needClip ? /* @__PURE__ */ import_react27.default.createElement("defs", null, /* @__PURE__ */ import_react27.default.createElement("clipPath", {
    ...
    value: function renderDotItem(option, props) {
      ...
      if (/* @__PURE__ */ import_react27.default.isValidElement(option)) {
        dotItem = /* @__PURE__ */ import_react27.default.cloneElement(option, props);
      } else if ((0, import_isFunction12.default)(option)) {
        dotItem = option(props);
      } else {
        var className = (0, import_classnames19.default)("recharts-line-dot", option ? option.className : "");
        dotItem = /* @__PURE__ */ import_react27.default.createElement(Dot, _extends20({}, props, {
          className
        }));
      }
      return dotItem;
...
var generateCategoricalChart = function generateCategoricalChart2(_ref6) {
  ...
  return _temp = _class = /* @__PURE__ */ function(_Component) {
    ...
    function CategoricalChartWrapper(_props) {
      ...
      _this.handleReceiveSyncEvent = function(cId, chartId, data2) {
        var syncId = _this.props.syncId;
        if (syncId === cId && chartId !== _this.uniqueChartId) {
          _this.clearDeferId();
          _this.deferId = defer && defer(_this.applySyncEvent.bind(_assertThisInitialized17(_this), data2));
        }
      };
      ...
      _this.renderCursor = function(element) {
        ...
        return /* @__PURE__ */ (0, import_react28.isValidElement)(element.props.cursor) ? /* @__PURE__ */ (0, import_react28.cloneElement)(element.props.cursor, cursorProps) : /* @__PURE__ */ (0, import_react28.createElement)(cursorComp, cursorProps);
      };
      _this.renderPolarAxis = function(element, displayName, index) {
        ...
        return /* @__PURE__ */ (0, import_react28.cloneElement)(element, _objectSpread24(_objectSpread24({}, axisOption), {}, {
          className: axisType,
      ...
      _this.renderGrid = function(element) {
        ...
        return /* @__PURE__ */ (0, import_react28.cloneElement)(element, {
      ...
      _this.renderLegend = function() {
        ...
        return /* @__PURE__ */ (0, import_react28.cloneElement)(item, _objectSpread24(_objectSpread24({}, otherProps), {}, {
          chartWidth: width,
          chartHeight: height,
          margin,
      ...
      _this.renderTooltip = function() {
        ...
        return /* @__PURE__ */ (0, import_react28.cloneElement)(tooltipItem, {
      ...
      _this.renderGraphicChild = function(element, displayName, index) {
        ...
        var graphicalItem = /* @__PURE__ */ (0, import_react28.cloneElement)(element, _objectSpread24(_objectSpread24({}, item.props), itemEvents));
      ...
      _this.renderCustomized = function(element, displayName, index) {
        return /* @__PURE__ */ (0, import_react28.cloneElement)(element, _objectSpread24(_objectSpread24({
    ...
    _createClass18(CategoricalChartWrapper, [{
      ...
      value: function applySyncEvent(data2) {
        ...
        if (!(0, import_isNil10.default)(data2.dataStartIndex) || !(0, import_isNil10.default)(data2.dataEndIndex)) {
        ...
        } else if (!(0, import_isNil10.default)(data2.activeTooltipIndex)) {
          ...
          this.setState(_objectSpread24(_objectSpread24({}, data2), {}, {
            activeLabel,
            activeCoordinate,
            activePayload,
            activeTooltipIndex
      ...
      value: function renderAxis(axisOptions, element, displayName, index) {
        ...
        return /* @__PURE__ */ import_react28.default.createElement(CartesianAxis, _extends21({}, axisOptions, {
      ...
      value: function renderClipPath() {
        ...
        return /* @__PURE__ */ import_react28.default.createElement("defs", null, /* @__PURE__ */ import_react28.default.createElement("clipPath", {
          id: clipPathId
      ...
      value: function render() {
        ...
        var _this$props6 = this.props, children = _this$props6.children, className = _this$props6.className, width = _this$props6.width, height = _this$props6.height, style = _this$props6.style, compact = _this$props6.compact, others = _objectWithoutProperties12(_this$props6, ["children", "className", "width", "height", "style", "compact"]);
        ...
        if (compact) {
          return /* @__PURE__ */ import_react28.default.createElement(Surface, _extends21({}, attrs, {
            width,
            height
          }), this.renderClipPath(), renderByOrder(children, map3));
        }
        var events = this.parseEventsOfWrapper();
        return /* @__PURE__ */ import_react28.default.createElement("div", _extends21({
        ...
        }), /* @__PURE__ */ import_react28.default.createElement(Surface, _extends21({}, attrs, {
          width,
          height
  ...
  }(import_react28.Component), _class.displayName = chartName, _class.defaultProps = _objectSpread24({
    layout: "horizontal",
    stackOffset: "none",
    barCategoryGap: "10%",
    barGap: 4,
    ...
    if (data2 !== prevState.prevData || width !== prevState.prevWidth || height !== prevState.prevHeight || layout !== prevState.prevLayout || stackOffset !== prevState.prevStackOffset || !shallowEqual(margin, prevState.prevMargin)) {
      ...
      var updatesToState = _objectSpread24(_objectSpread24({}, getTooltipData(prevState, data2, layout)), {}, {
    ...
    if (!isChildrenEqual(children, prevState.prevChildren)) {
      var hasGlobalData = !(0, import_isNil10.default)(data2);
    ...
    if (/* @__PURE__ */ (0, import_react28.isValidElement)(option)) {
      dot = /* @__PURE__ */ (0, import_react28.cloneElement)(option, props);
    } else if ((0, import_isFunction13.default)(option)) {
      dot = option(props);
    } else {
      dot = /* @__PURE__ */ import_react28.default.createElement(Dot, props);
    }
...
function useHydrated() {
  let [hydrated, setHydrated] = (0, import_react29.useState)(() => !hydrating);
  (0, import_react29.useEffect)(function hydrate() {
    hydrating = false;
    setHydrated(true);
  }, []);
  return hydrated;
...
function DashboardStatsRoute() {
  ...
  return /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement(DashHeader, {
    title: "Stats"
  }), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement(ClientOnly, {
 ...
 * LICENSE file in the root directory of this source tree.
 */
//# sourceMappingURL=/build/routes/dashboard/stats-CLQTO5YY.js.map
