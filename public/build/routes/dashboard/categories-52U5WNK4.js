...
function DashboardCategoryRoute() {
  ...
  const [categoryDelelteId, setCategoryDeleteId] = (0, import_react4.useState)(null);
  ...
  return /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement(DashHeader, {
  ...
  }) : null, categoryEdit ? /* @__PURE__ */ React.createElement(Modal, {
    ...
    type: "text",
    id: "name",
    defaultValue: categoryEdit == null ? void 0 : categoryEdit.name,
    name: "name",
    className: "bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg  block w-full p-2.5",
    required: true
  })), /* @__PURE__ */ React.createElement("div", {
    ...
    value: "edit",
    className: "text-white border-2 border-gray-800 bg-gray-900 focus:ring-4 focus:outline-none focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2 disabled:opacity-50"
  }, "Save ", isSubmiting ? "..." : "")))) : null, message ? /* @__PURE__ */ React.createElement(Toast, {
    message,
...
//# sourceMappingURL=/build/routes/dashboard/categories-52U5WNK4.js.map
