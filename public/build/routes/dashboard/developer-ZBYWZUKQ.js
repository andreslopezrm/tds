...
function DashboardDeveloperRoute() {
  ...
  const [enpointUrl, setEndpointUrl] = (0, import_react3.useState)("");
  const apiKeyValue = showApiKey ? apiKey == null ? void 0 : apiKey.value : "******************";
  const endpointUrlShow = `${baseUrl}/api/tips?api_key=${apiKey == null ? void 0 : apiKey.value}`;
  const endpointUrlHidden = `${baseUrl}/api/tips?api_key=${apiKeyValue}`;
...
//# sourceMappingURL=/build/routes/dashboard/developer-ZBYWZUKQ.js.map
