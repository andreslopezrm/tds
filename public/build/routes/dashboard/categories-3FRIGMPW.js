...
function DashHeader({ title }) {
  return /* @__PURE__ */ React.createElement("section", {
    ...
    type: "button",
    className: "text-gray-900 hover:text-white border-2 border-gray-800 hover:bg-gray-900 focus:ring-4 focus:outline-none focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2 md:hidden"
  }, "Logout"));
}
...
//# sourceMappingURL=/build/routes/dashboard/categories-3FRIGMPW.js.map
