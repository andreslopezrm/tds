...
function Toast() {
  return /* @__PURE__ */ React.createElement("div", {
    id: "toast-success",
    className: "flex items-center p-4 mb-4 w-full max-w-xs rounded-lg shadow text-gray-400 bg-gray-900",
    role: "alert"
  }, /* @__PURE__ */ React.createElement("div", {
    className: "inline-flex flex-shrink-0 justify-center items-center w-8 h-8 rounded-lg bg-green-800 text-green-200"
    ...
    className: "sr-only"
  }, "Check icon")), /* @__PURE__ */ React.createElement("div", {
    className: "ml-3 text-sm font-normal"
  }, "Item moved successfully."), /* @__PURE__ */ React.createElement("button", {
    type: "button",
...
function DashboardCategoryRoute() {
  ...
  }, "Acept")))) : null, /* @__PURE__ */ React.createElement(Toast, null));
}
export {
  DashboardCategoryRoute as default
};
//# sourceMappingURL=/build/routes/dashboard/categories-FEB3UJRU.js.map
