...
function DeveloperList({ apiKey, visible, onToogleVisible }) {
  ...
  }, visible ? "Hidden" : "View"), /* @__PURE__ */ React.createElement(Form, {
    method: "post"
  }, /* @__PURE__ */ React.createElement("button", {
    type: "submit",
...
function DashboardDeveloperRoute() {
  ...
  const [showApiKey, setShowApiKey] = (0, import_react4.useState)(false);
  const [message, setMessage] = (0, import_react4.useState)();
  (0, import_react4.useEffect)(() => {
    if (data == null ? void 0 : data.updated) {
...
//# sourceMappingURL=/build/routes/dashboard/developer-PHARXADP.js.map
