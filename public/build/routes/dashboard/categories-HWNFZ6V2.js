...
function Modal({ children, onClose }) {
  return /* @__PURE__ */ React.createElement("div", {
    ...
    className: "max-w-3xl m-8 relative inline-flex items-center justify-center p-1 overflow-hidden text-sm font-medium text-gray-900 rounded-lg group bg-black"
  }, /* @__PURE__ */ React.createElement("div", {
...
//# sourceMappingURL=/build/routes/dashboard/categories-HWNFZ6V2.js.map
