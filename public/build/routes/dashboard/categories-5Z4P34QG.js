...
init_react();
init_esm();
function LoadMore({ total, current, path, offset, perPage: perPage2 }) {
  console.log({ total, current, path, perPage: perPage2, offset });
  if (current >= total) {
    return null;
  }
  return /* @__PURE__ */ React.createElement("div", {
...
function DashboardCategoryRoute() {
  const { total, categories, offset } = useLoaderData();
...
//# sourceMappingURL=/build/routes/dashboard/categories-5Z4P34QG.js.map
