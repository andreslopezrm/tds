...
function DashboardCategoryRoute() {
  ...
  const [showCreateModal, setShowCreateModal] = (0, import_react6.useState)(false);
  const [message, setMessage] = (0, import_react6.useState)();
  const [categoryEdit, setCategoryEdit] = (0, import_react6.useState)(null);
  const [categoryDelelteId, setCategoryDeleteId] = (0, import_react6.useState)(null);
  ...
  }), categories.length < total ? /* @__PURE__ */ React.createElement(Link, {
    to: "/dashboard/categories"
  }, "Load more") : null, showCreateModal ? /* @__PURE__ */ React.createElement(CategoryModalCreate, {
    isSubmiting,
...
//# sourceMappingURL=/build/routes/dashboard/categories-36WJTEBY.js.map
