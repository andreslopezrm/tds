...
function DashboardIndexRoute() {
  ...
  return /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement(DashHeader, {
    ...
    className: "text-gray-900 border-2 border-gray-800 rounded-lg px-5 py-2.5 text-center md:flex-1"
  }, /* @__PURE__ */ React.createElement("h4", null, "Total Categories"), /* @__PURE__ */ React.createElement("p", null, totalCategories)), /* @__PURE__ */ React.createElement("div", {
    className: "text-gray-900 border-2 border-gray-800 rounded-lg px-5 py-2.5 text-center md:flex-1"
  }, /* @__PURE__ */ React.createElement("h4", null, "Total Tips"), /* @__PURE__ */ React.createElement("p", null, totalTips)), /* @__PURE__ */ React.createElement("div", {
    className: "text-gray-900 border-2 border-gray-800 rounded-lg px-5 py-2.5 text-center md:flex-1"
  }, /* @__PURE__ */ React.createElement("h4", null, "Total Request Today"), /* @__PURE__ */ React.createElement("p", null, totalStats)))));
}
export {
  DashboardIndexRoute as default
};
//# sourceMappingURL=/build/routes/dashboard/index-P6QDJ6LX.js.map
