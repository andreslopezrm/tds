...
function IndexRoute() {
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("nav", {
    ...
    className: "mt-8 text-2xl text-gray-900 font-extralight md:text-3xl md:w-9/12 md:mt-12"
  }, "The easy-to-integrate platform to offer the users of your products the tips of the day"))));
}
export {
  IndexRoute as default
};
//# sourceMappingURL=/build/routes/index-EE6KJZHK.js.map
