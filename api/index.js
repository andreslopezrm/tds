...
function loader6({ request }) {
  return getQueryStringParameter(request, "api_key") ? (0, import_node6.json)({}) : (0, import_node6.json)({ status: "forbidden", error: "Forbiden Access" }, { status: 403 });
}
