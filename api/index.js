...
// app/styles/app.css
var app_default = "/build/_assets/app-UVLEFHQZ.css";
...
var import_ssr5 = require("@clerk/remix/ssr.server"), import_node5 = require("@remix-run/node"), import_react17 = require("@remix-run/react"), import_chart = require("chart.js"), import_react_chartjs_2 = require("react-chartjs-2");

// app/db/stats.server.ts
var import_redis_om5 = require("redis-om");
var import_dayjs = __toESM(require("dayjs")), FORMAT = "DD-MM-YYYY", Stat = class extends import_redis_om5.Entity {
...
function DashboardStatsRoute() {
  let { stats } = (0, import_react17.useLoaderData)(), options = {
    responsive: !0,
    plugins: {
      legend: {
        position: "top"
...
var import_node7 = require("@remix-run/node"), import_remix_utils = require("remix-utils");
async function loader7({ request }) {
  let apiKey = getQueryStringParameter(request, "api_key");
  if (!apiKey)
    return (0, import_remix_utils.cors)(request, (0, import_node7.json)({ status: "forbidden", error: "Forbiden Access" }, { status: 403 }));
  let userId = await getUserIdByApiKey(apiKey);
  if (!userId)
    return (0, import_remix_utils.cors)(request, (0, import_node7.json)({ status: "forbidden", error: "Forbiden Access", apiKey }, { status: 403 }));
  ...
  return (0, import_remix_utils.cors)(request, (0, import_node7.json)({ status: "ok", tip: (tip == null ? void 0 : tip.description) ?? null }));
}
...
var import_ssr7 = require("@clerk/remix/ssr.server"), import_node8 = require("@remix-run/node"), import_react23 = require("@remix-run/react");
...
function IndexRoute() {
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("nav", {
    ...
    to: "sign-in",
    className: "text-slate-600"
  }, "Sign In"), /* @__PURE__ */ React.createElement(import_react23.Link, {
    className: "bg-black text-white rounded px-4 py-2 border border-solid border-black hover:bg-white hover:text-black",
    to: "sign-up"
  ...
  }, "Get starter"), /* @__PURE__ */ React.createElement(import_react23.Link, {
    to: "/about",
