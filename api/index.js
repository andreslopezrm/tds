...
// app/styles/app.css
var app_default = "/build/_assets/app-HGZADCN6.css";
...
async function getTotalDashboard(userId) {
  let [totalCategories, totalTips, totalStats, lastTips] = await Promise.all([
...
function DashboardIndexRoute() {
  ...
  return /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement(DashHeader, {
    ...
    scope: "col",
    className: "py-3 px-6"
  }, "Description"))), /* @__PURE__ */ React.createElement("tbody", null, lastTips.length > 0 ? lastTips.map((tip) => /* @__PURE__ */ React.createElement("tr", {
    className: "bg-white border-b",
    key: tip.entityId
  }, /* @__PURE__ */ React.createElement("th", {
    scope: "row",
    className: "py-4 px-6 font-medium text-gray-900 whitespace-nowrap"
  }, tip.description))) : /* @__PURE__ */ React.createElement("tr", {
...
var import_ssr8 = require("@clerk/remix/ssr.server"), import_node9 = require("@remix-run/node"), import_react24 = require("@remix-run/react");
...
function IndexRoute() {
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("nav", {
    ...
    to: "sign-in",
    className: "text-slate-600"
  }, "Sign In"), /* @__PURE__ */ React.createElement(import_react24.Link, {
    className: "bg-black text-white rounded px-4 py-2 border border-solid border-black hover:bg-white hover:text-black",
    to: "sign-up"
  }, "Sign Up"))), /* @__PURE__ */ React.createElement("div", {
  ...
  }, "Get starter"), /* @__PURE__ */ React.createElement(import_react24.Link, {
    to: "/about",
